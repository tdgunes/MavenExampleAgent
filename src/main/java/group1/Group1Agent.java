 ...
 */
public class Group1Agent extends AbstractNegotiationParty {
    private final String description = "Group1Agent";

    private Bid lastReceivedOffer; // offer on the table
    private Bid myLastOffer;

    private Set<Bid> bidSet = Sets.newHashSet();
    ...
    public void init(NegotiationInfo info) {
        ...
        // for testing Google commons dependency
        bidSet.clear();
        System.out.println(linearProgram.getName());
    }
